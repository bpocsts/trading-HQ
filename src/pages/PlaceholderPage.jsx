...
const PAGE_META = {
  ...
  '/habits': { icon: '🔥', title: 'Habit Tracker', sub: 'Build and maintain positive trading habits' },
  '/mistakes': { icon: '⚠', title: 'Mistake Tracker', sub: 'Identify and eliminate recurring trading errors' },
  ...
  return (
    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16, padding: 20 }}>
      ...
      >
        ...
        <div style={{ marginTop: 16, padding: '8px 20px', background: 'rgba(57,255,20,0.05)', border: '1px dashed var(--border2)', borderRadius: 8, fontSize: 11, color: 'var(--text3)' }}>
